...
I'm a Software Engineer undergraduate student and certified Digital Designer from <a href ="https://utr.edu.mx"> Universidad Tecnologica El Retono </a> specialized in secure full-stack backend engineering, data manipulation, backend data pipelines, database management and cloud-ready containerized microservices prototyping. 
Demonstrated expertise in building scalable web APIs REST using Node.js, NestJS, and ExpressJS, integrated with SQL/NoSQL databases and Redis caching. Proven track record in automating enterprise document workflows and leading user-centered
interface design.
...
- Diving enthusiasted into <a href="https://www.ibm.com/mx-es/think/topics/machine-learning"> Machine Learning </a> 💻
- Fully interested in gainning experience with <a href="https://cloud.google.com/learn/what-is-artificial-intelligence?hl=es-419"> AI </a> 🤖
- As a graduated Digital Designer, website concept creator and developer I'm sure I'll build your website from 0 😁
- Daily learning about tools, programming and able to learn courses for my professional career 📖

<h2>
   <picture>
      <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f9e0/512.webp" type="image/webp">
      <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f9e0/512.gif" alt="🧠" width="20" height="20">
   </picture>
   Skills set 
</h2>
...
![Python](https://img.shields.io/badge/Python-3379FF?style=for-the-badge&logo=python&logoColor=white&logoSize=5)
